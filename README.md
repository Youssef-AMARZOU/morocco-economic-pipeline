...
[![ZenML](https://img.shields.io/badge/ZenML-0.96-6B46C1?style=flat)](https://zenml.io)
...
<img height="180em" src="https://streak-stats.demolab.com?user=Youssef-AMARZOU&theme=tokyonight&hide_border=true&background=0d1117" />
...
| Model Performance |
|-------------------|
| ![Perf](economic_data/charts/10_model_performance.png) |

#### Real Data Charts (World Bank Education)

| Education Enrollment | Education Spending | GDP (real) |
|----------------------|-------------------|------------|
| ![Edu](economic_data/charts_real/01_education_real.png) | ![Spend](economic_data/charts_real/02_education_spending_real.png) | ![GDP](economic_data/charts_real/03_gdp_real.png) |

| Unemployment (real) | Inflation (real) | Trade (real) |
|---------------------|------------------|--------------|
| ![Unemp](economic_data/charts_real/04_unemployment_real.png) | ![Infl](economic_data/charts_real/05_inflation_real.png) | ![Trade](economic_data/charts_real/06_trade_real.png) |

| Dashboard (real) |
|------------------|
| ![Dash](economic_data/charts_real/07_dashboard_real.png) |
